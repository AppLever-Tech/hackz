...
class _EvaluateIdeaDialogState extends State<_EvaluateIdeaDialog> {
  ...
  /// Red (low) → green (high) for scores 1–10.
  static Color _hueForScore(int value) {
  ...
  static Color _tileSurface(int value) {
    final c = _hueForScore(value);
  ...
  void initState() {
    super.initState();
    final raw = widget.item.score?.score ?? 5;
    _selectedScore = raw.round().clamp(1, 10);
  ...
  Widget _buildScorePicker(ThemeData theme) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
        Row(
          ...
          children: <Widget>[
            ...
            ShaderMask(
              ...
              shaderCallback: (Rect bounds) {
                final Color c = _hueForScore(_selectedScore);
                return LinearGradient(
                  colors: <Color>[
                    Color.lerp(c, Colors.black, 0.12)!,
                    c,
                  ],
                ).createShader(bounds);
              },
        ...
        LayoutBuilder(
          builder: (BuildContext context, BoxConstraints constraints) {
            final bool useWrap = constraints.maxWidth < 400;
            final List<Widget> chips = List<Widget>.generate(10, (int i) {
              final int v = i + 1;
              final bool selected = v == _selectedScore;
              final Color accent = _hueForScore(v);
              ...
              Widget tile = AnimatedContainer(
                ...
                child: AspectRatio(
                  ...
                  child: Material(
                    ...
                    child: InkWell(
                      onTap: () => setState(() => _selectedScore = v),
              ...
              final double tileWidth = constraints.maxWidth / 5;
              return SizedBox(width: tileWidth, child: padded);
            });
        ...
        const SizedBox(height: 8),
        Text(
          'Tap a value from 1 (needs work) through 10 (excellent)',
    ...
    return AlertDialog(
      ...
      content: SizedBox(
        ...
        child: Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: <Widget>[
            _buildScorePicker(Theme.of(context)),
