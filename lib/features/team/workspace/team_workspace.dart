...
abstract final class TeamWorkspace {
  ...
  static void push(BuildContext context, String teamId, {UserModel? actor}) {
  ...
  static void open(BuildContext context, String teamId, {UserModel? actor}) {
    final String id = teamId.trim();
    if (id.isEmpty) return;
    final String routeId = 'team:$id';
    final current = HkzWorkspace.controllerOf(context).current;
  ...
  static void openUserFromTeam(BuildContext context, String userId, {UserModel? actor}) {
  ...
  static void openIdeaFromTeam(BuildContext context, TeamIdeaPreview preview, {UserModel? actor}) {
