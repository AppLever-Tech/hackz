...
abstract final class EvaluationTemplateWorkspace {
  static WorkspaceRoute _route(String id, {String? departmentCode}) {
  ...
  static void open(
    ...
    HkzWorkspace.open(context, _route(id, departmentCode: departmentCode));
  }
  ...
  static void push(
    ...
    final current = HkzWorkspace.controllerOf(context).current;
    if (current != null && current.id == routeId) return;
    HkzWorkspace.push(context, _route(id, departmentCode: departmentCode));
  }
}
