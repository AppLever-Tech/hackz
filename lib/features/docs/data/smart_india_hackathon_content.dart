            ...
            children: <Widget>[
              ...
              DocumentationCard(
                ...
                child: _bulletList(context, const <String>[
                  ...
                  'Register team members, form teams and collect idea submissions',
            ...
            children: <Widget>[
              DocumentationTimeline(
                ...
                items: <({String title, String body, Widget? pill})>[
                  ...
                  (
                    title: 'Team Member Registration & Profiles',
                    body: 'Team members register and complete skills, interests and experience profiles.',
                    pill: const DocumentationStatusPill(label: '2', kind: DocStatusKind.custom),
                  ),
                  (
                    title: 'Team Formation',
                    body: 'Team members form teams aligned to skills and problem preferences.',
              ...
              _stageCard(
                ...
                outcome: 'Team members and faculty can browse the full SIH problem set on Hackz.',
                modules: const <String>['Problems', 'Domains', 'CSV Import'],
              ),
              const SizedBox(height: 12),
              _stageCard(
                context,
                name: '2. Team Member Registration & Profiles',
                purpose: 'Onboard participating team members with complete profiles.',
                activities: const <String>[
                  'Team member registration',
                  'Create profiles',
                  'Capture skills, interests and experience',
                ],
                outcome: 'A ready pool of team member profiles for team formation.',
                modules: const <String>['Users', 'Team Members'],
              ),
              const SizedBox(height: 12),
              _stageCard(
                context,
              ...
              return Wrap(
                ...
                children: <Widget>[
                  ...
                  _featureCard(
                    context,
                    icon: AppIcons.users,
                    title: 'Team Member & Team Management',
                    body: 'Register team members, complete profiles and form balanced SIH teams.',
                    cols: cols,
                    maxWidth: c.maxWidth,
                  ),
                  _featureCard(
                  ...
                  _featureCard(
                    ...
                    body: 'Least-privilege workspaces for team members, faculty, judges and admins.',
                    cols: cols,
                    maxWidth: c.maxWidth,
                  ),
                ],
